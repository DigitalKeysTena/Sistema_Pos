...
// VERSIÓN CORREGIDA - Busca gastos asociados a la apertura actual
session_start();
...
try {
    ...
    // ====================================
    // OBTENER GASTOS DE LA APERTURA ACTUAL
    ...
    $sql_gastos = "
        ...
        AND (
            Id_Apertura_Caja = ?
            OR (Id_Apertura_Caja IS NULL AND DATE(Fecha_Gasto) = ?)
        )
    ...
    error_log("GASTOS - Apertura: $id_apertura, Total encontrados: " . count($gastos) . ", Total: $total");
